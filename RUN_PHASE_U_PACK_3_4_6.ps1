...
Write-Host "=== AFIP Phase U Pack 3.4.6 ==="
Write-Host "Production Research Certification"

python -m pytest tests/test_phase_u_pack_3_4_6.py -q
...
Write-Host ""
Write-Host "PASS - Phase U Pack 3.4.6 validated."
