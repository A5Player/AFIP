...
Add-Once -Target (Join-Path $root "AFIP_PROJECT_DATABASE.md") `
    -AppendFile (Join-Path $root "AFIP_PROJECT_DATABASE_PACK_7_0_APPEND.md") `
    -Marker "Milestone S Pack 7.0"

Add-Once -Target (Join-Path $root "HANDOFF.md") `
    -AppendFile (Join-Path $root "HANDOFF_PACK_7_0_APPEND.md") `
    -Marker "Milestone S Pack 7.0 Handoff"

Write-Host "Pack 7.0 documentation updates complete."
