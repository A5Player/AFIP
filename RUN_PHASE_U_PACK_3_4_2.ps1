...
Write-Host "=== AFIP Phase U Pack 3.4.2 ==="
Write-Host "Comprehensive Walk-Forward Research Engine"

python -m pytest tests/test_phase_u_pack_3_4_2.py -q
...
Write-Host ""
Write-Host "PASS - Phase U Pack 3.4.2 validated."
