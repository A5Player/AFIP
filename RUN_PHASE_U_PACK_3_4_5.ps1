...
Write-Host "=== AFIP Phase U Pack 3.4.5 ==="
Write-Host "Research Dashboard"

python -m pytest tests/test_phase_u_pack_3_4_5.py -q
...
Write-Host ""
Write-Host "PASS - Phase U Pack 3.4.5 validated."
