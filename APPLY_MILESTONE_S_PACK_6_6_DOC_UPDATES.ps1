...
Add-Once -Target (Join-Path $root "AFIP_PROJECT_DATABASE.md") `
    -AppendFile (Join-Path $root "AFIP_PROJECT_DATABASE_PACK_6_6_APPEND.md") `
    -Marker "Milestone S Pack 6.6"

Add-Once -Target (Join-Path $root "HANDOFF.md") `
    -AppendFile (Join-Path $root "HANDOFF_PACK_6_6_APPEND.md") `
    -Marker "Milestone S Pack 6.6 Handoff"

Write-Host "Pack 6.6 documentation updates complete."
