...
Write-Host "=== AFIP Phase U Pack 3.4.7 ==="
Write-Host "Blind Historical Research Replay Engine"

python -m pytest tests/test_phase_u_pack_3_4_7.py -q
...
Write-Host ""
Write-Host "PASS - Phase U Pack 3.4.7 validated."
