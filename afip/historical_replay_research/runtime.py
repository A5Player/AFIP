...
class AppendOnlyResearchDataset:
    ...
    DATASET_NAMES = (
        ...
        "atr_buffer_batch_evaluations", "atr_buffer_research_standards",
        "atr_buffer_cumulative_aggregates", "atr_buffer_pattern_observations",
        "staggered_entry_batch_evaluations", "staggered_entry_research_standards",
        "staggered_entry_cumulative_aggregates", "staggered_entry_pattern_observations",
        "single_unit_profit_batch_evaluations", "single_unit_profit_research_standards",
        "single_unit_profit_cumulative_aggregates", "single_unit_profit_pattern_observations",
        "initial_capital_batch_evaluations", "initial_capital_research_standards",
        "initial_capital_cumulative_aggregates", "initial_capital_pattern_observations",
        ...
        "a20_holding_exit_observations", "a20_holding_exit_rankings",
