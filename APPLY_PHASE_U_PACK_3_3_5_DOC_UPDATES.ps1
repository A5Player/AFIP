...
$dbArgs = @{ Target='AFIP_PROJECT_DATABASE.md'; Source='AFIP_PROJECT_DATABASE_PHASE_U_PACK_3_3_5_APPEND.md'; Marker='Phase U Pack 3.3.5' }
$handoffArgs = @{ Target='HANDOFF.md'; Source='HANDOFF_PHASE_U_PACK_3_3_5_APPEND.md'; Marker='Phase U Pack 3.3.5 Handoff' }
Append-Once @dbArgs
